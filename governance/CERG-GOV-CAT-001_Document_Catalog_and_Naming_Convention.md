...
| [`CERG-OPN-TOOLS-004`](../practice-assets/tools/threat-intel-validation-v1.md) | Threat-Intel-Validated Control Baseline — CISA KEV + Ransomware TTP Mapping | Consulting Practice Lead | Draft |
