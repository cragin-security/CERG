...
| Vulnerability Backlog Item | Exposure Management Lead | [PRC-VM-001](../procedures/CERG-PRC-VM-001_Exposure_Management_Procedure.md) | Vulnerability requires tracking to remediation or exception | Proves remediation status and SLA performance |
