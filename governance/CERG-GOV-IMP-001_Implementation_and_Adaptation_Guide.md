...
## 12. Adoption Safety Guide (Referenced)

This section formerly contained the full text of the Adoption Safety Guide (CERG-GOV-IMP-002). The source document has been marked as DEPRECATED.

**Safety Guide Key Points:**
1. Identify a named security owner before adopting new controls.
2. Obtain executive support for guardrails and evidence discipline.
3. Define scope clearly — do not try to adopt everything at once.
4. Track decisions and exceptions — undocumented decisions are not defensible.
5. Start with the MVC spine (8 documents), prove the operating rhythm, then expand.

*For full context, see the archived IMP-002 document.*
## 13. Small Team Adoption Path

This section covers the CERG Lite adoption path for teams with fewer than 15 FTEs. It was consolidated from CERG-GOV-IMP-003.
...
## 14. Role-Based Implementation Checklists

This section provides role-based checklists for CERG implementation. It was consolidated from CERG-GOV-IMP-006.
...
## 15. Role Reader Paths

This section maps CERG documents to specific roles, helping readers find the content relevant to them. It was consolidated from CERG-GOV-IMP-007.
...
|---------|------|--------|-------------------|
| 1.0 | 2026-06-27 | CERG Practice | Initial consolidation: appended safety guide, small team path, checklists, and reader paths from IMP-002, IMP-003, IMP-006, IMP-007 |
